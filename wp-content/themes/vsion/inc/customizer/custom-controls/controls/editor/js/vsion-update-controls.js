            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#Vsion_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('Vsion_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="vsion_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="vsion_feature_thumbnail-button">Change Image</button> ' +
