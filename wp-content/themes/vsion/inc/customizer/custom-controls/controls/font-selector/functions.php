...
require VSION_PARENT_INC_DIR . '/customizer/custom-controls/controls/font-selector/class/class-font-selector.php';
/**
 * List of standard fonts
 */
function vsion_font_selector_get_standard_fonts() {
	return apply_filters(
		'vsion_font_selector_standard_fonts_array', array(
 ...
 * @since 1.1.38
 */
function vsion_font_selector_enqueue_google_font( $font ) {
	...
	$subsets = apply_filters( 'vsion_font_subsets', array( 'latin' ) );
	if ( ! empty( $subsets ) ) {
		$font_subsets = array();
	...
	$weights = apply_filters( 'vsion_font_weights', array( '300', '400', '500', '700' ) );
