 ...
 * @access public
 */
class Vsion_Customizer_Range_Control extends WP_Customize_Control {
	...
	/**
	 * Vsion_Customizer_Range_Control constructor.
	 *
 ...
 */
function vsion_sanitize_range_value( $input ) {
	if ( vsion_is_json( $input ) ) {
