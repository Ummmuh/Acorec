 ...
 * @package     Vsion
 * @author      Vsion
 * @copyright   Copyright (c) 2022, Vsion_
 * @since       1.0
 */
...
class Vsion_Icon_Picker_Control extends WP_Customize_Control
{
  ...
  public function __construct( $manager, $id, $args = array(), $options = array() ) {
    $this->icons = $this->Vsion_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'vsion-icon-picker-css', VSION_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.css', false );
			 
		wp_enqueue_script( 'vsion-icon-picker-js', VSION_PARENT_URI .'/assets/fonticonpicker/jquery.fonticonpicker.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}
