...
function vsion_frontpagesectionsscroll( section_id ){
 ...
 jQuery('body').on('click', '#sub-accordion-panel-vsion_homepage_sections .control-subsection .accordion-section-title', function(event) {
        var section_id = jQuery(this).parent('.control-subsection').attr('id');
        vsion_frontpagesectionsscroll( section_id );
});