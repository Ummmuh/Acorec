...
( function( $ ) {
	...
	VSION_ControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'vsion-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'vsion-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'vsion-control-trigger.' + hook, callback );
	    },
	};
	 ...
	 *
	 * @since 1.0.0
	 * @class VSION_CustomizerToggles
	 */
	VSION_CustomizerToggles = {
		...
		[
			{
				...
				callback: function( vsion_header_type ) {

					var vsion_header_type = api( 'vsion_header_type' ).get();

					if ( 'header-1' == vsion_header_type  || 'header-4' == vsion_header_type  || 'header-5' == vsion_header_type  || 'header-6' == vsion_header_type  || 'header-7' == vsion_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( vsion_header_type ) {
					...
					if ( 'header-1' == vsion_header_type  || 'header-4' == vsion_header_type || 'header-6' == vsion_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( vsion_header_type ) {
					...
					if ( 'header-4' == vsion_header_type  || 'header-5' == vsion_header_type || 'header-6' == vsion_header_type) {
						return true;
					}
					return false;
				}
			...
			
			{
				...
				callback: function( vsion_header_type ) {
					...
					if ( 'header-5' == vsion_header_type  || 'header-7' == vsion_header_type) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( vsion_header_type ) {
					...
					if ( 'header-5' == vsion_header_type || 'header-6' == vsion_header_type) {
						return true;
					}
					return false;
				}
		...
		[
			{
				...
				callback: function( vsion_footer_type ) {

					var vsion_footer_type = api( 'vsion_footer_type' ).get();

					if ( 'footer-one' == vsion_footer_type || 'footer-two' == vsion_footer_type ) {
						return true;
					}
					return false;
				}
			},
			{
				...
				callback: function( vsion_footer_type ) {
					...
					if ( 'footer-two' == vsion_footer_type ) {
						return true;
					}
					return false;
				}
