(function ($) {
    ...
    wp.vsion_customizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                vsion_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.vsion_customizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.vsion_customizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.vsion_customizerRepeater.iconPickerToggle($(this));
        });
