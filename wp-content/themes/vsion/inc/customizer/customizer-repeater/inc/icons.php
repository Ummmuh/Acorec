<div class="iconpicker-popover popover bottomLeft">
    ...
    <div class="popover-title">
        <input type="search" class="form-control iconpicker-search" placeholder="<?php echo esc_attr__('Type to filter','vsion'); ?>">
    </div>
    <div class="popover-content">
        <div class="iconpicker">
            <div class="iconpicker-items">
				...
				<i data-type="iconpicker-item" title=".fa-tv" class="fa fa-tv"></i>
				<i data-type="iconpicker-item" title=".fa-trophy" class="fa fa-trophy"></i>
				<i data-type="iconpicker-item" title=".fa-stethoscope" class="fa fa-stethoscope"></i>
				<i data-type="iconpicker-item" title=".fa-child" class="fa fa-child"></i>
				<i data-type="iconpicker-item" title=".fa-transgender-alt" class="fa fa-transgender-alt"></i>
