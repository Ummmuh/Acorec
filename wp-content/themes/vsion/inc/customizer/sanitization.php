 ...
 */
function vsion_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function vsion_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function vsion_sanitize_html( $html ) {
 ...
 */
function vsion_sanitize_image( $image, $setting ) {
 ...
 */
function vsion_sanitize_nohtml( $nohtml ) {
 ...
 */
function vsion_sanitize_number_absint( $number, $setting ) {
 ...
 */
function vsion_sanitize_select( $input, $setting ) {
 ...
 */
function vsion_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function vsion_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function vsion_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
...
function vsion_sanitize_sortable( $val, $setting ) {
...
function vsion_sanitize_typography_fonts( $input ) {
	$standard = vsion_font_selector_get_standard_fonts();
	$google = vsion_font_selector_get_google_fonts_array();
