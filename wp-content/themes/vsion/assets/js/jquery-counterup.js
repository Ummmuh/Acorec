            ...
            e.waypoint(
                function (t) {
                    !(function () {
                        ...
                        for (var d = r; d >= 1; d--) {
                            var p = parseFloat((o / r) * d).toFixed(c);
                            if (s) {
                                p = parseInt((a / r) * d);
                        ...
                        e.data("counterup-func", function () {
                            e.html(e.data("counterup-nums").shift()), e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), u.delay) : (e.data("counterup-nums", null), e.data("counterup-func", null), n.callback.call(this));
                        }),
